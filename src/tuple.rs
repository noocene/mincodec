...
macro_rules! tuple_impls {
    ($($deser:ident $ser:ident $sere:ident $len:expr => ($($n:tt $name:ident)+))+) => {
        $(
            #[doc = "Autogenerated error type"]
            #[derive(Debug)]
            pub enum $sere<$($name),+> {
                $(
                    #[doc = "Autogenerated error variant that encapsulates the error type for a certain binding"]
                    $name($name)
                ),+
            }

            #[doc = "Autogenerated serialization provider"]
            ...
            #[doc = "Autogenerated deserialization provider"]
            #[allow(non_snake_case)]
