...
macro_rules! impl_primitives {
    ...
    (cat numbers { $($ty:ty as $deser:ident + $ser:ident),* }) => {
        $(
            #[doc = "Autogenerated deserialization provider for a numeric type"]
            pub struct $deser {
                data: Option<Fill<[u8; size_of::<$ty>()]>>,
            }

            #[doc = "Autogenerated serialization provider for a numeric type"]
            pub struct $ser {
...
/// Read-side of a simple codec for `bool`
///
/// Uses a single bit
#[derive(Debug)]
...
/// Write-side of a simple codec for `bool`
///
/// Uses a single bit
#[derive(Debug)]
...
/// Codec used for unit types
///
/// This acts as a null codec, usable
/// for any type that does not transmit any
/// data in its serialization process. This is true, definitionally, of any
/// unit type, i.e. a type that has a single value.
